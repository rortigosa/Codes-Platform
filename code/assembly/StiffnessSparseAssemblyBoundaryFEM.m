...
function [INDEXI,INDEXJ,...
            DATA]           =  StiffnessSparseAssemblyBoundaryFEM(iedge,dim,mesh,...
                                                                element_assembly)   
%--------------------------------------------------------------------------
% x dof's. 
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
INDEXI                      =  [Kxx_indexi;   Kxphi_indexi;   Kxq_indexi;...
                                Kphix_indexi; Kphiq_indexi];
INDEXJ                      =  [Kxx_indexj;   Kxphi_indexj;   Kxq_indexj;...
                                Kphix_indexj; Kphiq_indexj];
DATA                        =  [Kxx_data;     Kxphi_data;     Kxq_data;...
                                Kphix_data;   Kphiq_data];
end
