...
function str              =  ParallelInternalWorkCGCCascadeAssembly(str)    
%--------------------------------------------------------------------------
...
for ielem=1:str.mesh.volume.n_elem  
    ...
    %----------------------------------------------------------------------
    element_assembly      =  ParallelInternalWorkResidualStiffnessCGCCascade(ielem,str.quadrature,str.solution,...
                                      str.geometry,str.mesh,str.fem,...
                                      str.vectorisation,str.material_information);    
    %----------------------------------------------------------------------
    % Sparse assembly 
    %----------------------------------------------------------------------
    [INDEXI,INDEXJ,DATA]  =  StiffnessSparseAssemblyInternalWorkU(ielem,str.geometry.dim,str.mesh,...
                                                    element_assembly);         
    ...
    %----------------------------------------------------------------------
    [INDEXI,INDEXJ,DATA]  =  ParallelInternalVectorsAssemblyU(ielem,str.geometry.dim,str.mesh,...
                                                    element_assembly);
