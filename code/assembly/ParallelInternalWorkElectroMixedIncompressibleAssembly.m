...
function str              =  ParallelInternalWorkElectroMixedIncompressibleAssembly(str)    
%--------------------------------------------------------------------------
...
parfor ielem=1:str.mesh.volume.n_elem  
    ...
    %----------------------------------------------------------------------
    element_assembly      =  ParallelInternalWorkResidualStiffnessElectroMixedIncompressible(ielem,str.quadrature,str.solution,...
                                      str.geometry,str.mesh,str.fem,str.vectorisation,str.material_information);    
    %----------------------------------------------------------------------
    % Sparse assembly
    %----------------------------------------------------------------------
    [INDEXI,INDEXJ,DATA]  =  StiffnessSparseAssemblyInternalWorkElectroIncompressible(ielem,str.geometry.dim,str.mesh,...
                                                    element_assembly);         
    ...
    %----------------------------------------------------------------------
    [INDEXI,INDEXJ,DATA]  =  ParallelInternalVectorsAssemblyElectroIncompressible(ielem,str.geometry.dim,str.mesh,element_assembly);
