...
function str              =  ParallelInternalWorkUAssembly(str)    
%--------------------------------------------------------------------------
...
parfor ielem=1:str.mesh.volume.n_elem  
    ...
    %----------------------------------------------------------------------
    element_assembly      =  ParallelInternalWorkResidualStiffnessU(ielem,str.quadrature,str.solution,...
    ...
    %----------------------------------------------------------------------
    [INDEXI,INDEXJ,DATA]  =  ParallelInternalVectorsAssemblyU(ielem,str.geometry.dim,str.mesh,element_assembly);
