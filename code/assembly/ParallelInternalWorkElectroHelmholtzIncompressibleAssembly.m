...
function str    =  ParallelInternalWorkElectroHelmholtzIncompressibleAssembly(str)    
%--------------------------------------------------------------------------
...
parfor ielem=1:str.mesh.volume.n_elem  
    ...
    %----------------------------------------------------------------------
    element_assembly      =  ParallelInternalWorkResidualStiffnessElectroHelmholtzIncompress(ielem,str.quadrature,str.solution,...
