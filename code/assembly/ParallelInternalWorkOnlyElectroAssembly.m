...
function str    =  ParallelInternalWorkOnlyElectroAssembly(str)    
%--------------------------------------------------------------------------
...
parfor ielem=1:str.mesh.volume.n_elem  
    ...
    %----------------------------------------------------------------------
    element_assembly      =  ParallelInternalWorkResidualStiffnessOnlyElectro(ielem,str.quadrature,str.solution,...
