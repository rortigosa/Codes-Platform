...
function solution                =  UpdatedIncrementalVariablesElectroMixedIncompBEMFEM(dim,mesh,solution,time_integrator,contact) 
%--------------------------------------------------------------------------
% Update x 
%--------------------------------------------------------------------------
initial                          =  1;
...
%--------------------------------------------------------------------------
initial                          =  final + 1;
final                            =  initial - 1 + mesh.surface.q0.n_nodes;
D_q0                             =  solution.incremental_solution(initial:final);
solution.q0                      =  solution.q0 + D_q0;
%--------------------------------------------------------------------------
