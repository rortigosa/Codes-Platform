...
if isempty(flu)
   str.data.actual_dim       =  str.data.dim;
 switch str.data.dim
    case {12,13}
        str.data.dim         =  str.mec_u_dof;
 end
    switch str.data.dim
        case 2
            flu.control.z = 0;
...
if flu.control.z
    ...
    name_stress_mec_iso = {'s_mec_iso_xx','s_mec_iso_yy','s_mec_iso_zz','s_mec_iso_yx','s_mec_iso_zx','s_mec_iso_zy'};
    name_stress_mec_aniso = {'s_mec_aniso_xx','s_mec_aniso_yy','s_mec_aniso_zz','s_mec_aniso_yx','s_mec_aniso_zx','s_mec_aniso_zy'};
    name_stress_mec = {'s_mec_xx','s_mec_yy','s_mec_zz','s_mec_yx','s_mec_zx','s_mec_zy'};
    name_stress_diel_iso = {'s_diel_iso_xx','s_diel_iso_yy','s_diel_iso_zz','s_diel_iso_yx','s_diel_iso_zx','s_diel_iso_zy'};
    name_stress_diel_aniso = {'s_diel_aniso_xx','s_diel_aniso_yy','s_diel_aniso_zz','s_diel_aniso_yx','s_diel_aniso_zx','s_diel_aniso_zy'};
    name_stress_diel = {'s_diel_xx','s_diel_yy','s_diel_zz','s_diel_yx','s_diel_zx','s_diel_zy'};
    name_stress_piezo = {'s_piezo_xx','s_piezo_yy','s_piezo_zz','s_piezo_yx','s_piezo_zx','s_piezo_zy'};
    name_stress_elec = {'s_elec_xx','s_elec_yy','s_elec_zz','s_elec_yx','s_elec_zx','s_elec_zy'};
    ...
    name_cauchy_mec_iso = {'sigma_mec_iso_xx','sigma_mec_iso_yy','sigma_mec_iso_zz','sigma_mec_iso_yx','sigma_mec_iso_zx','sigma_mec_iso_zy'};
    name_cauchy_mec_aniso = {'sigma_mec_aniso_xx','sigma_mec_aniso_yy','sigma_mec_aniso_zz','sigma_mec_aniso_yx','sigma_mec_aniso_zx','sigma_mec_aniso_zy'};
    name_cauchy_mec = {'sigma_mec_xx','sigma_mec_yy','sigma_mec_zz','sigma_mec_yx','sigma_mec_zx','sigma_mec_zy'};
    name_cauchy_diel_iso = {'sigma_diel_iso_xx','sigma_diel_iso_yy','sigma_diel_iso_zz','sigma_diel_iso_yx','sigma_diel_iso_zx','sigma_diel_iso_zy'};
    name_cauchy_diel_aniso = {'sigma_diel_aniso_xx','sigma_diel_aniso_yy','sigma_diel_aniso_zz','sigma_diel_aniso_yx','sigma_diel_aniso_zx','sigma_diel_aniso_zy'};
    name_cauchy_diel = {'sigma_diel_xx','sigma_diel_yy','sigma_diel_zz','sigma_diel_yx','sigma_diel_zx','sigma_diel_zy'};
    name_cauchy_piezo = {'sigma_piezo_xx','sigma_piezo_yy','sigma_piezo_zz','sigma_piezo_yx','sigma_piezo_zx','sigma_piezo_zy'};
    name_cauchy_elec = {'sigma_elec_xx','sigma_elec_yy','sigma_elec_zz','sigma_elec_yx','sigma_elec_zx','sigma_elec_zy'};
    ...
    name_D_diel_iso = {'eul_elec_di_iso_disp_x','eul_elec_di_iso_disp_y','eul_elec_di_iso_disp_z'};
    name_D_diel_aniso = {'eul_elec_di_aniso_disp_x','eul_elec_di_aniso_disp_y','eul_elec_di_aniso_disp_z'};
    name_D_diel = {'eul_elec_di_disp_x','eul_elec_di_disp_y','eul_elec_di_disp_z'};
    name_D_piezo = {'eul_elec_piezo_disp_x','eul_elec_piezo_disp_y','eul_elec_piezo_disp_z'};
    %---------------------------
    % Lagrangian electric displacement.
    %---------------------------
    name_D0 = {'lag_elec_disp_x','lag_elec_disp_y','lag_elec_disp_z'};
    name_D0_diel_iso = {'lag_elec_di_iso_disp_x','lag_elec_di_iso_disp_y','lag_elec_di_iso_disp_z'};
    name_D0_diel_aniso = {'lag_elec_di_aniso_disp_x','lag_elec_di_aniso_disp_y','lag_elec_di_aniso_disp_z'};
    name_D0_diel = {'lag_elec_di_disp_x','lag_elec_di_disp_y','lag_elec_di_disp_z'};
    name_D0_piezo = {'lag_elec_piezo_disp_x','lag_elec_piezo_disp_y','lag_elec_piezo_disp_z'};
    %---------------------------
    % Nodal loads.
    %---------------------------
    ...
    %---------------------------
    name_Phi = {'Phi'};
    name_Phi_mec_iso = {'Phi_mec_iso'};    
    name_Phi_mec_aniso = {'Phi_mec_aniso'};    
    name_Phi_mec = {'Phi_mec'};
    name_Phi_diel_iso = {'Phi_diel_iso'};
    name_Phi_diel_aniso = {'Phi_diel_aniso'};
    name_Phi_diel = {'Phi_diel'};
    name_Phi_piezo = {'Phi_piezo'};
    name_Phi_elec = {'Phi_elec'};
    %---------------------------
    %Electric intensity.
    %---------------------------
    ...
    name_stress_mec_iso = {'s_mec_iso_xx','s_mec_iso_yy','s_mec_iso_yx'};
    name_stress_mec_aniso = {'s_mec_aniso_xx','s_mec_aniso_yy','s_mec_aniso_yx'};
    name_stress_mec = {'s_mec_xx','s_mec_yy','s_mec_yx'};
    name_stress_diel_iso = {'s_diel_iso_xx','s_diel_iso_yy','s_diel_iso_yx'};
    name_stress_diel_aniso = {'s_diel_aniso_xx','s_diel_aniso_yy','s_diel_aniso_yx'};
    name_stress_diel = {'s_diel_xx','s_diel_yy','s_diel_yx'};
    name_stress_piezo = {'s_piezo_xx','s_piezo_yy','s_piezo_yx'};
    name_stress_elec = {'s_elec_xx','s_elec_yy','s_elec_yx'};
    ...
    name_cauchy_mec_iso = {'sigma_mec_iso_xx','sigma_mec_iso_yy','sigma_mec_iso_yx'};
    name_cauchy_mec_aniso = {'sigma_mec_aniso_xx','sigma_mec_aniso_yy','sigma_mec_aniso_yx'};
    name_cauchy_mec = {'sigma_mec_xx','sigma_mec_yy','sigma_mec_yx'};
    name_cauchy_diel_iso = {'sigma_diel_iso_xx','sigma_diel_iso_yy','sigma_diel_iso_yx'};
    name_cauchy_diel_aniso = {'sigma_diel_aniso_xx','sigma_diel_aniso_yy','sigma_diel_aniso_yx'};
    name_cauchy_diel = {'sigma_diel_xx','sigma_diel_yy','sigma_diel_yx'};
    name_cauchy_piezo = {'sigma_piezo_xx','sigma_piezo_yy','sigma_piezo_yx'};
    name_cauchy_elec = {'sigma_elec_xx','sigma_elec_yy','sigma_elec_yx'};
...
switch options 
    case 'fem_electromech'
        ...
        switch str.data.actual_dim
            case {2,3}
                 F_i = @(s) reshape(s.assemb_force.total_force(1:(s.data.dim*s.n_nodes)),s.data.dim,s.n_nodes);
        end
        F = @(s) eT(s.postproc.F);
        ...
        switch str.data.actual_dim
            case {2,3}
                 data = {{nodes,nodes0,potential,displ,S,S_mec_iso,S_mec_aniso,S_mec,S_diel_iso,S_diel_aniso,S_diel,S_piezo,S_elec,S_volumetric,S_deviatoric,...
                          ...
                          sigma_deviatoric,sigma_pressure,E,E0,D,D_diel_iso,D_diel_aniso,D_diel,D_piezo,D0,D0_diel_iso,D0_diel_aniso,D0_diel,D0_piezo,...
                          F_i,F,J,J_electric,J0_electric,Phi,Phi_mec_iso,Phi_mec_aniso,Phi_mec,Phi_diel_iso,Phi_diel_aniso,Phi_diel,Phi_piezo,...
                          Phi_elec,eigenvalsandvects, eldata}};
%                  data = {{nodes,nodes0,potential,displ,S,S_mec_iso,... 
%                           sigma,sigma_mec_iso,...
%                           E,E0,D,D0,...
%                           F_i,F,J,J_electric,J0_electric,eigenvalsandvects, eldata}};
            case {12,13}
                 data = {{nodes,nodes0,potential,displ,S,S_mec_iso,S_mec_aniso,S_mec,S_diel_iso,S_diel_aniso,S_diel,S_piezo,S_elec,S_volumetric,S_deviatoric,...
                          sigma,sigma_mec_iso,sigma_mec_aniso,sigma_mec,sigma_diel_iso,sigma_diel_aniso,sigma_diel,sigma_piezo,sigma_elec,sigma_volumetric,...
                          sigma_deviatoric,sigma_pressure,E,E0,D,D_diel_iso,D_diel_aniso,D_diel,D_piezo,D0,D0_diel_iso,D0_diel_aniso,D0_diel,D0_piezo,...
                          F,J,J_electric,J0_electric,Phi,Phi_mec_iso,Phi_mec_aniso,Phi_mec,Phi_diel_iso,Phi_diel_aniso,Phi_diel,Phi_piezo,...
                          Phi_elec,eigenvalsandvects, eldata}};
        end                
%        data = {{nodes,nodes0,potential,displ,S,E,E0,D0,F_i,F, eigenvalsandvects, eldata}};
        %----------------------------------
        ...
        switch str.data.actual_dim
            case {2,3}
                 variables = [name_pos name_pos0 name_potential name_displ name_stress name_stress_mec_iso name_stress_mec_aniso...
                              ...
                              name_cauchy_deviatoric name_cauchy_pressure name_E name_E0 name_D name_D_diel_iso name_D_diel_aniso name_D_diel name_D_piezo...
                              name_D0 name_D0_diel_iso name_D0_diel_aniso name_D0_diel name_D0_piezo name_F_i name_F name_J name_J_electric name_J0_electric...
...
%                  variables = [name_pos name_pos0 name_potential name_displ name_stress name_stress_mec_iso ...
%                               name_cauchy name_cauchy_mec_iso ...
%                               name_E name_E0 name_D ...
%                               name_D0 name_F_i name_F name_J name_J_electric name_J0_electric name_eigval name_eigvect];        
            case {12,13}
                 variables = [name_pos name_pos0 name_potential name_displ name_stress name_stress_mec_iso name_stress_mec_aniso...
                              name_stress_mec name_stress_diel_iso name_stress_diel_aniso name_stress_diel name_stress_piezo name_stress_elec...
                              name_stress_volumetric name_stress_deviatoric name_cauchy name_cauchy_mec_iso name_cauchy_mec_aniso name_cauchy_mec...
                              name_cauchy_diel_iso name_cauchy_diel_aniso name_cauchy_diel name_cauchy_piezo name_cauchy_elec name_cauchy_volumetric...
                              name_cauchy_deviatoric name_cauchy_pressure name_E name_E0 name_D name_D_diel_iso name_D_diel_aniso name_D_diel name_D_piezo...
                              name_D0 name_D0_diel_iso name_D0_diel_aniso name_D0_diel name_D0_piezo name_F name_J name_J_electric name_J0_electric...
                              name_Phi name_Phi_mec_iso name_Phi_mec_aniso name_Phi_mec name_Phi_diel_iso name_Phi_diel_aniso ...
                              name_Phi_diel name_Phi_piezo name_Phi_elec  name_eigval name_eigvect];        
        end        
%        variables = [name_pos name_pos0 name_potential name_displ name_stress name_E name_E0 name_D0 name_F_i name_F name_eigval name_eigvect];        
%         variables = [name_pos];        
        fem_export = 1;
        switch str.data.dim
            case 2
