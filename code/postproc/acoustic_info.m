...
function [str,flup,strp]                 = acoustic_info(flu,str,n_alpha,n_beta,filename,opt,append,interpolate)
...
str                                      = postprocessing_acoustic_tensor(str,n_alpha,n_beta);
